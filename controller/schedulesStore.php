    ...
    switch($action){
        ...
        case 'addFirstSchedule':
            ...
            if($data[0]['COUNT(*)'] >= 7){
                ...
                if(strlen($openL) == 0 && preg_match("/^(?:2[0-3]|[01][0-9]):[0-5][0-9]$/", ((int)$openL)) == false){
                ...
                if(strlen($openM) == 0 && preg_match("/^(?:2[0-3]|[01][0-9]):[0-5][0-9]$/", ((int)$openM)) == false){
                ...
                if(strlen($openW) == 0 && preg_match("/^(?:2[0-3]|[01][0-9]):[0-5][0-9]$/", ((int)$openW)) == false){
                ...
                if(strlen($openJ) == 0 && preg_match("/^(?:2[0-3]|[01][0-9]):[0-5][0-9]$/", ((int)$openJ)) == false){
                ...
                if(strlen($openV) == 0 && preg_match("/^(?:2[0-3]|[01][0-9]):[0-5][0-9]$/", ((int)$openV)) == false){
                ...
                if(strlen($openS) == 0 && preg_match("/^(?:2[0-3]|[01][0-9]):[0-5][0-9]$/", ((int)$openS)) == false){
                ...
                if(strlen($openD) == 0 && preg_match("/^(?:2[0-3]|[01][0-9]):[0-5][0-9]$/", ((int)$openD)) == false){
